...
from repository.profile_repository import fetch_content_template, fetch_county, fetch_municipality, fetch_region, fetch_content_history, fetch_single_content
...
async def get_content_template(geo_level: str, body: str = Body(..., media_type="text/plain")):
    if(geo_level == 'region'):
        profile = await fetch_region()
